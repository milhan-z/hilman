...
export const PAGE_SCHEMAS: Record<string, PageSchema> = {
  ...
  about: {
    ...
    title: "About",
    blurb:
      "A card clipped to a sheet of paper, like your old About Me page: your photo, name and contacts on the card; your details, a few handwritten lines, your experience and your software on the sheet. Your story, the people around you and your moments follow below. Anything left empty is simply left out.",
    fields: [
      {
        kind: "media",
        key: "portrait_cutout",
        label: "Portrait cut-out",
        hint: "A half-body photo of you with the background removed (a transparent PNG), about 4:5. Shown on the card's yellow block, like the old About Me page.",
      },
      ...
      { kind: "text", key: "portrait_caption", label: "Portrait caption", hint: "Optional. A few handwritten words under the photo." },
      {
        ...
        hint: "The last word is written in red script, like a signature, e.g. “M Hilman Azhar”.",
      },
      {
        kind: "longtext",
        key: "summary",
        label: "Card summary",
        hint: "One or two sentences beside your photo: who you are and what you do.",
        rows: 3,
      },
      { kind: "text", key: "contact_email", label: "Email on the card", placeholder: "name@example.com" },
      { kind: "text", key: "instagram", label: "Instagram on the card", hint: "Your handle, with or without the @.", placeholder: "hilman_azhar" },
      {
        kind: "text",
        key: "phone",
        label: "Phone / WhatsApp on the card",
        hint: "Optional. Anyone can read it, so leave it empty to keep your number off the site.",
        placeholder: "+62 …",
      },
      {
        kind: "stringList",
        key: "details",
        label: "Handwritten details",
        itemLabel: "Line",
        hint: "Short lines written in red under the card: your full name, your studies, anything else you'd put on a CV. Your interests follow them.",
      },
      {
        kind: "longtext",
        key: "personal_note",
        label: "Handwritten paragraph",
        hint: "A few sentences in your own voice, written by hand on the sheet under your details.",
        rows: 5,
      },
      {
        kind: "objectList",
      ...
      },
      {
        ...
        key: "lede",
        label: "Story opening",
        hint: "Optional. A large first line above your story, under “Hi, I'm Hilman.”",
        rows: 3,
      },
      {
        kind: "stringList",
      ...
      },
      {
        ...
        itemLabel: "Interest",
        hint: "Things you enjoy, inside or outside your work. Written on the sheet after your details. Short phrases work well.",
      },
      {
        kind: "stringList",
        key: "focus",
