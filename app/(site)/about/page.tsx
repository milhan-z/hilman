...
export default async function AboutPage() {
  ...
  return (
    // The whole page is one sheet of cream linen paper, in both themes: it
    // carries the light theme, so everything written on it is ink on paper,
    // and it runs down to the footer, taking up the footer's top margin.
    <div data-theme="light" className="paper-linen -mb-16 text-ink">
      <div className="mx-auto max-w-wide px-5 pb-20 pt-12 sm:px-8 sm:pb-28 sm:pt-16 lg:px-12">
        ...
        {d.community_story && (
          <SectionReveal>
            <section id="people" className="mt-16 scroll-mt-24 border-t border-dashed border-line-strong pt-14 sm:mt-20 sm:pt-16" aria-labelledby={d.community_heading ? "community-heading" : undefined} aria-label={d.community_heading ? undefined : "People and community"}>
        ...
        <section className="mt-14 border-2 border-ink bg-cream px-6 py-9 sm:mt-16 sm:px-10 sm:py-12" aria-labelledby="about-connect-heading">
